...
| **scrape\_interval**           | Integer | Optional. The interval, in seconds, at which Prometheus should scrape its targets. Defaults to 15. |
| **evaluation\_interval**       | Integer | Optional. The interval, in seconds, at which Prometheus should evaluate its alerting rules. Defaults to 15. |
